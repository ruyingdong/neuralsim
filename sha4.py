...
GIF_NAME = "cloth_pinn_with_initial_mesh3.gif"   # output GIF filename
...
BATCH = 1000                   # PDE time samples per epoch
...
ax.add_collection(Line3DCollection(pos0_np[springs.cpu().numpy()], linestyles='dashed', colors='gray', alpha=0.5))
